...
import PhoneLinks from "@/components/PhoneLinks/PhoneLinks";
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <Hero
          ...
          text={"Solitaire-skillz"}
        />
        {/* <PhoneLinks applePlayUrl="" androidPlayUrl="" /> */}
        {deviceType === "desktop" ? <GameQR gameQRImage={gameQRImage} /> : ""}
        <Testimonial />
        <Accordion />
        <TipsAndTricks
